...
namespace Camelot
{
	...
	/// </summary>
	public class propertymeters : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.DataGrid dgPmet;
		...
		private void getMeters(int propid)
		{
			SqlConnection conn = new SqlConnection();
			SqlCommand cmd =  new SqlCommand();
		...
		public void set_prop(Object sender, DataGridCommandEventArgs e)
		{
			...
			Session["curProperty"] = lprop;
			Response.Redirect("propertymeters.aspx");
		}

		public void set_met(Object sender, DataGridCommandEventArgs e)
		{
			//			lmet= (Camelot.classes.cmetility)Session["curmet"];
			//			lmet.metility_ID = e.Item.Cells[1].Text;
			//			Session["curmet"] = lmet;
		}
		...
		public void dgmets_ItemDataBound(Object sender, DataGridItemEventArgs e)
		{
			if(e.Item.ItemType != ListItemType.Header && e.Item.ItemType != ListItemType.Footer)
			{
				...
				fButton.Attributes.Add("onclick", "javascript:window.showModalDialog('meterdetails.aspx?met=" + DataBinder.Eval(e.Item.DataItem, "met") + "','metdets','dialogHeight: 775px; dialogWidth: 900px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');self.document.location.href = 'propertymeters.aspx';");
			}
		}
		...
		private void Button1_ServerClick(object sender, System.EventArgs e)
		{
			...
			Session["met_new"] = true;
			Response.Write("<script>window.showModalDialog('meterdetails.aspx?met=','metdets','dialogHeight: 700px; dialogWidth: 900px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
			Response.Write("<script>self.document.location.href = 'propertymeters.aspx';</script>");
		}
