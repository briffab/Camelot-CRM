...
namespace Camelot
{
	...
	/// </summary>
	public class guardian : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Button btnVet;
		...
		private void pop_pic()
		{
			...
			cmd.Parameters.Add(
				new SqlParameter("@P_ID", lguard.Guardian_ID));
			cmd.Parameters.Add(
		...
		private void pop_guard(string guard_id, string prop_id)
		{
			...
			while(rdr.Read())
			{
				...
				this.txtinit.Text = rdr["initialS"].ToString();
		...
		{
			Response.Write("<script>window.showModalDialog('changeproperty.aspx?fac=','newprop','dialogHeight: 400px; dialogWidth: 800px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}

		private void btnVet_Click(object sender, System.EventArgs e)
		{
			Response.Write("<script>window.showModalDialog('guardian_vet.aspx?src=guard','vet','dialogHeight: 400px; dialogWidth: 650px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}

		private void btnCorr_Click(object sender, System.EventArgs e)
		{
			Response.Write("<script>window.showModalDialog('guardiancorrespondence.aspx','guard','dialogHeight: 700px; dialogWidth: 900px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}

		private void btnOther_Click(object sender, System.EventArgs e)
		{
			Session["visitaddr"] = "view";
			Response.Write("<script>window.showModalDialog('residentaddress.aspx','addr','dialogHeight: 550px; dialogWidth: 650px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}
