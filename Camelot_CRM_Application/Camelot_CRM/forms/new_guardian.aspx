<%@ Page language="c#" Codebehind="new_guardian.aspx.cs" AutoEventWireup="false" Inherits="Camelot.new_guardian" %>
	...
	<BODY onunload="parent.location.reload(true);">
		...
		<form id="Form1" runat="server">
			<table width="96%" align="center">
				<tr>
					<td class="logon" width="30%" height="14"><asp:label id="lblTitle" runat="server" Font-Size="20pt"></asp:label></td>
					...
					<td vAlign="top" width="50%">
						<table width="100%" valign="top">
							<tr>
								...
								<td class="data" width="60%" height="21"><asp:dropdownlist id="cmbtitle" runat="server" CssClass="logon" Width="184"></asp:dropdownlist></td>
							</tr>
							<tr vAlign="top">
							...
							<tr vAlign="top">
								...
								<td class="data" width="60%" height="21"><asp:textbox id="txtlname" runat="server" Width="184px"></asp:textbox><asp:label id="Label29" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label11" runat="server">Date of Birth</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtDOB" runat="server" Width="184px"></asp:textbox>
									<asp:label id="Label36" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr vAlign="top">
							...
							<TR>
								...
								<td class="data" width="60%" height="21"><asp:dropdownlist id="cmbSex" runat="server" CssClass="logon" Width="184">
							...
							<tr vAlign="top">
								...
								<td class="data" width="60%" height="21"><asp:textbox id="txtDtStart" runat="server" Width="184px"></asp:textbox><asp:label id="Label30" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label27" runat="server">Date Finished</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtDtFinished" runat="server" Width="184px"></asp:textbox><asp:label id="Label31" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
						</table>
					</td>
					<td vAlign="top" width="50%">
						<table cellPadding="0" width="100%">
							...
							<TR>
								...
								<td class="data" width="60%" height="21"><asp:dropdownlist id="cmbStat" runat="server" CssClass="logon" Width="184"></asp:dropdownlist>&nbsp;</td>
							</TR>
							<tr vAlign="top">
							...
							<tr vAlign="top">
								...
								<td class="data" width="60%" height="21"><asp:textbox id="txtpbu" runat="server" Width="184px"></asp:textbox><asp:label id="Label33" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr vAlign="top">
							...
							<tr vAlign="top">
								...
								<td class="data" width="60%" height="23"><asp:textbox id="txtfire" runat="server" Width="184px"></asp:textbox><asp:label id="Label34" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label23" runat="server">Insurance</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtins" runat="server" Width="184px"></asp:textbox><asp:label id="Label35" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Larger"
										ForeColor="Red">*</asp:label></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="logon" width="147"><asp:label id="lblFProp" runat="server" Width="136px">Find Property</asp:label></td>
								<td class="data" width="60%"><asp:textbox id="txtProp" runat="server" Width="184px"></asp:textbox>&nbsp;<asp:button id="btnPserch" runat="server" CssClass="button" Text="Find"></asp:button></td>
							</tr>
							<tr>
								<td class="logon" width="147" colSpan="2"><asp:listbox id="lbProperties" ondblclick="setproperty(this.form.lbProperties, this.form.txtSProp, this.form.txtPropID)"
										runat="server" Width="424px" Height="112px"></asp:listbox></td>
							</tr>
							<tr>
								<td class="logon" width="147"><asp:label id="lblProp" runat="server" Width="136px">Property</asp:label></td>
								<td class="data" width="60%"><asp:textbox id="txtSProp" runat="server" Width="184px"></asp:textbox></td>
							</tr>
							<tr>
								<td class="logon" width="147"><asp:label id="lblPropID" runat="server" Width="136px">Property ID</asp:label></td>
			...
			<table height="30" width="96%" align="center">
				<tr>
					...
					<td vAlign="middle" align="left" width="50%"><asp:button id="btnBank" runat="server" CssClass="button" Text="Bank Details"></asp:button></td>
