...
namespace Camelot
{
	...
	/// </summary>
	public class inspections_NL : System.Web.UI.Page
	{
		...
		public void set_prop(Object sender, DataGridCommandEventArgs e)
		{
			...
			Session["curProperty"] = lprop;
			Response.Redirect("inspections_NL.aspx");
		}
		...
		private void btnPrint_ServerClick(object sender, System.EventArgs e)
		{
			...
			Response.Write("<script>self.document.location.href = 'inspections_NL.aspx';</script>");
		}
	}
