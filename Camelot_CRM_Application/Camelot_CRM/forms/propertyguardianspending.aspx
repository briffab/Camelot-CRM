<%@ Page language="c#" Codebehind="propertyguardianspending.aspx.cs" AutoEventWireup="false" Inherits="Camelot.propertyguardianspending" %>
	...
	<body onkeydown="keystroke()">
		...
		<form ID="Form1" name="Form1" runat="server">
			<table width="96%" height="54" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="Label1" runat="server" Font-Size="20pt">Pending Property Guardians</asp:Label>
					</td>
				</tr>
			</table>
			...
			<table width="96%" align="center">
				<tr>
					<td class="logon" width="50%" valign="middle" align="left">
