<%@ Page language="c#" Codebehind="propertyguardians.aspx.cs" AutoEventWireup="false" Inherits="Camelot.propertyguardians" %>
	...
	<body onkeydown="keystroke()">
		...
		<form ID="Form1" name="Form1" runat="server">
			<table width="96%" height="54" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="Label1" runat="server" Font-Size="20pt">Property Guardians</asp:Label>
					</td>
				</tr>
			</table>
