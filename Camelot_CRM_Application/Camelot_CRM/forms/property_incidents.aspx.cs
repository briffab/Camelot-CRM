...
namespace Camelot
{
	...
	/// </summary>
	public class property_incidents : System.Web.UI.Page
	{
		...
		private void getIncidents(int propid)
		{
			...
			cmd.CommandText = "get_open_Incidents";
		...
		public void set_prop(Object sender, DataGridCommandEventArgs e)
		{
			...
			Session["curProperty"] = lprop;
			Response.Redirect("property_incidents.aspx");
		}
		...
		private void Button1_ServerClick(object sender, System.EventArgs e)
		{
			...
			Session["inc_new"] = true;
			Response.Write("<script>window.showModalDialog('incidentdetails.aspx?inc=&prop=" + lprop.Property_ID + "','incdets','dialogHeight: 700px; dialogWidth: 950px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
			Response.Write("<script>self.document.location.href = 'property_incidents.aspx';</script>");
		}
