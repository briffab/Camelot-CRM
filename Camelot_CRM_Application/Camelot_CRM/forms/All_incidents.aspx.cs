...
namespace Camelot
{
	...
	/// </summary>
	public class All_incidents : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label lblCnt;
		private int sort = 0;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				if(!Page.IsPostBack)
				{
					...
					getIncidents();	
					Session["sort"] = sort;
					this.lblCnt.Text = "Number of open incidents : " + this.dgIncs.Items.Count;
				}
				linc.Incident_ID = "";
		...
		private void getIncidents()
		{
			...
			cmd.CommandText = "get_all_open_Incidents";
	...
	public void dgIncs_ItemDataBound(Object sender, DataGridItemEventArgs e)
		...
		private void Button1_ServerClick(object sender, System.EventArgs e)
		{
			...
			Response.Write("<script>window.showModalDialog('incidentdetails.aspx?inc=&prop=0','incdets','dialogHeight: 700px; dialogWidth: 950px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
			Response.Write("<script>self.document.location.href = 'all_incidents.aspx';</script>");
		}
	}
}
