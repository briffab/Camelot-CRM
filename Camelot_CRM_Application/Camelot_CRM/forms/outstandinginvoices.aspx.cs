...
namespace Camelot
{
	...
	/// </summary>
	public class outstandinginvoices : System.Web.UI.Page
	{
		...
		public void set_comp(Object sender, DataGridCommandEventArgs e)
		{
			...
			Response.Redirect("outstandinginvoices.aspx");
		}
		...
		private void getinvoices(int comp_id)
		{
			...
			cmd.CommandText = "get_out_company_invoices";
		...
		private void Button1_ServerClick(object sender, System.EventArgs e)
		{
			...
			Session["invoice_new"] = true;
			Response.Write("<script>window.showModalDialog('invoicedetails.aspx?inv=','inv','dialogHeight: 650px; dialogWidth: 900px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}
