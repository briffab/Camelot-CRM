...
namespace Camelot.forms
{
	...
	/// </summary>
	public class applicantdetails_ire : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{		
				...
				string scrp="<script>var rc = new Array(0,0);function doIt(){if(Form1.txtLname.value + Form1.txtFname.value != ''){rc= window.showModalDialog('placeGuard_ire.aspx?Title="+title + "','','dialogHeight:"+height+" px;dialogWidth:"+width+" px;');"+"\n";
		...
		private void btnCancel_Click(object sender, System.EventArgs e)
		{
			Session["app_edit"] = false;
			Session["app_save"] = false;
			Response.Redirect("applicantdetails_ire.aspx");
