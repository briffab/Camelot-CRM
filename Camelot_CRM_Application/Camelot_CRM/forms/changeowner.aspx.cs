...
namespace Camelot.forms
{
	...
	/// </summary>
	public class changeowner : System.Web.UI.Page
	{
		...
		private void saveproperty()
		{
			...
			if(oktosave)
			{
				...
				cmd.CommandText = "change_owner";

				cmd.Parameters.Add(
					new SqlParameter("@PROP_ID", lprop.Property_ID));
				cmd.Parameters.Add(
					new SqlParameter("@CCOMP_ID", lcomp.Company_ID));
				cmd.Parameters.Add(
					new SqlParameter("@NCOMP_ID", txtCompID.Text));
				cmd.Parameters.Add(
