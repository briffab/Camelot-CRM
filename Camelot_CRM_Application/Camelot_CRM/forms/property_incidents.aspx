<%@ Page language="c#" Codebehind="property_incidents.aspx.cs" AutoEventWireup="false" Inherits="Camelot.property_incidents" %>
	...
	<body onkeydown="keystroke()">
		...
		<form ID="Form1" name="Form1" runat="server">
			<table width="96%" height="54" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="Label1" runat="server" Font-Size="20pt">Open Property Incidents</asp:Label>
					</td>
				</tr>
			</table>
				...
				<tr>
					<td>
						<asp:datagrid id="dgIncs" name="dgIncs" runat="server" Width="100%" AutoGenerateColumns="False"
							...
							<HeaderStyle BackColor="#56a80f" ForeColor="#dae7ca" Font-Bold="True" HorizontalAlign="Left" />
							<Columns>
								<asp:ButtonColumn DataTextField="resolution_date" HeaderText="To be closed by" DataTextFormatString="{0:dd MMMM yyyy HH:mm}">
									<ItemStyle Width="15%" VerticalAlign="top" Font-Bold="True"></ItemStyle>
								</asp:ButtonColumn>
								<asp:BoundColumn DataField="inc" Visible="False"></asp:BoundColumn>
								<asp:BoundColumn DataField="resolution_date" Visible="False"></asp:BoundColumn>								
								<asp:BoundColumn DataField="urgency" HeaderText="Urgency">
