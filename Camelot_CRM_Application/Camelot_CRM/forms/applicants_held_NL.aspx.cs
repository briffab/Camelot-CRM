...
namespace Camelot.forms
{
	...
	/// </summary>
	public class applicants_held_NL : System.Web.UI.Page
	{
		...
		private string app_con = "server=192.168.75.1;integrated security=false;uid=sa;pwd=sa;database=registration_nl;";
		//private string app_con = "server=FUJI;integrated security=false;uid=sa;pwd=fvzappa3;database=registration_nl;";
		...
		private void get_applicants()
		{
			...
			conn.ConnectionString = "server=192.168.75.1;integrated security=false;uid=sa;pwd=sa;database=registration_nl;";
			//conn.ConnectionString = "server=FUJI;integrated security=false;uid=sa;pwd=fvzappa3;database=registration_nl;";
			conn.Open();
			cmd.Connection = conn;
			cmd.CommandType = CommandType.StoredProcedure;

			cmd.CommandText = "get_applicants_held";
		...
		public void dgApplicants_ItemDataBound(Object sender, DataGridItemEventArgs e)
		{
			if(e.Item.ItemType != ListItemType.Header && e.Item.ItemType != ListItemType.Footer)
			{
				...
				fButton.Attributes.Add("onclick", "javascript:window.showModalDialog('applicantdetails.aspx?app_id=" + DataBinder.Eval(e.Item.DataItem, "app_id") + "','appdets','dialogHeight: 750px; dialogWidth: 950px; dialogTop: 50px; dialogLeft:150px; edge: Raised; center: No; help: No; resizable: No; status: No;');");
			}
		}
