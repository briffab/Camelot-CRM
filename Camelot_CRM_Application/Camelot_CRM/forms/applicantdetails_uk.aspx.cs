...
namespace Camelot.forms
{
	...
	/// </summary>
	public class applicantdetails_uk : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{		
				...
				string scrp="<script>var rc = new Array(0,0);function doIt(){if(Form1.txtLname.value + Form1.txtFname.value != ''){rc= window.showModalDialog('placeGuard_UK.aspx?Title="+title + "','','dialogHeight:"+height+" px;dialogWidth:"+width+" px;');"+"\n";
