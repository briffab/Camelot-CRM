...
namespace Camelot.forms
{
	...
	/// </summary>
	public class guardcorr : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				{
					setvisible(false);
					guard = Request.QueryString["guard"];
					Session["mergeguard"] = guard;
					pop_lists();
				}
				guard = Session["mergeguard"].ToString();
				get_recipients();
			}
		}
		...
		private void get_recipients()
		{
			...
			cmd.Connection = conn;
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "get_guard_corr_recipients";
