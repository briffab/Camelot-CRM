<%@ Page language="c#" Codebehind="Notedetails.aspx.cs" AutoEventWireup="false" Inherits="Camelot.Notedetails" %>
	...
	<BODY>
		...
		<form id="Form1" runat="server">
			<table width="96%" height="54" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="Label1" runat="server" Font-Size="20pt">Note Details</asp:Label>
					</td>
				</tr>
			</table>
				...
				<tr>
					<td vAlign="top" width="50%">
						<table width="100%" valign="top">
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="lblDate" runat="server">Date</asp:label></td>
								<td class="data" width="60%" height="21">
									<asp:textbox id="txtDate" runat="server" Width="272px"></asp:textbox>&nbsp;<asp:label id="lblDateStar" runat="server" ForeColor="Red" Font-Size="Larger" Font-Names="Arial"
										Font-Bold="True">*</asp:label></td>
							</tr>
							<tr>
								<td class="logon" width="249" height="21"><asp:label id="Label5" runat="server">Contact</asp:label></td>
								<td class="data" width="60%" height="21">
									<asp:dropdownlist id="cmbContact" runat="server" Width="272px" CssClass="logon"></asp:dropdownlist></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label6" runat="server">Description</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtDesc" runat="server" Width="392px" Height="72px" TextMode="MultiLine"></asp:textbox></td>
							</tr>
							<tr>
