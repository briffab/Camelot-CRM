<%@ Page language="c#" Codebehind="placed_applicants_NL.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.placed_applicants_NL" %>
	...
	<body>
		...
		<form id="Form1" runat="server">
			<table width="96%" align="center">
				<tr>
					<td class="Logon" style="FONT-SIZE: 20pt"><br>Placed Guardian Applications</td>
				</tr>
			</table>
