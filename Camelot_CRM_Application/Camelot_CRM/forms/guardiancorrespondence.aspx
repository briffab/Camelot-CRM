<%@ Page language="c#" Codebehind="guardiancorrespondence.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.guardiancorrespondence" %>
	...
	<body onkeydown="keystroke()">
		...
		<form id="Form1" runat="server">
			<table width="96%" height="54" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="Label1" runat="server" Font-Size="20pt">Guardian Correspondence</asp:Label>
					</td>
				</tr>
				<tr>
					<td class="logon">
						<asp:Label id="lblGuard" runat="server" CssClass="logon"></asp:Label>
					</td>
				</tr>
			</table>
				...
				<tr>
					<td><asp:datagrid id="dgCorrs" runat="server" Width="100%" Font-Size="8pt" HorizontalAlign="Center"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="document" HeaderText="Document / Subject">
									<ItemStyle Width="33%" VerticalAlign="Top"></ItemStyle>
								</asp:BoundColumn>
							</Columns>
						</asp:datagrid></td>
				</tr>
