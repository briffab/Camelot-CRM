...
namespace Camelot.forms
{
	...
	/// </summary>
	public class applications_held_IRE : System.Web.UI.Page
	{
		...
		//private string app_con = "server=FUJI;integrated security=false;uid=sa;pwd=fvzappa3;database=registration_ire;";
		...
		private void get_applicants()
		{
			...
			cmd.CommandText = "get_held_applicants";
