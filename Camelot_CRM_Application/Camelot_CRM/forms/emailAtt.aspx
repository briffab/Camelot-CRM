<%@ Page language="c#" Codebehind="emailAtt.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.emailAtt" %>
				...
				<tr>
					...
					<td width="70%">
						<OBJECT id="Uploader" codeBase="XUpload.ocx" height="100" width="100%" classid="CLSID:E87F6C8E-16C0-11D3-BEF7-009027438003"
							...
							<PARAM NAME="_cx" VALUE="14579">
							<PARAM NAME="_cy" VALUE="2646">
							<PARAM NAME="Server" VALUE="ntsbs01">
							<PARAM NAME="Script" VALUE="/camelot_crm/forms/send_email_att.aspx">
