<%@ Page language="c#" Codebehind="applicantdetails.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.applicantdetails" %>
				...
				<tr>
					<td vAlign="top" width="50%">
						<table width="100%">
							...
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label3" runat="server">Initials</asp:label></td>
					...
					<td vAlign="top" width="50%">
						<table cellPadding="0" width="100%">
							...
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label10" runat="server">Pet</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtPet" runat="server" Width="184px"></asp:textbox></td>
							</tr>
							<tr vAlign="top">
							...
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label17" runat="server">Employer</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtEmp" runat="server" Width="184px"></asp:textbox></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label24" runat="server">Source of Income</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtSin" runat="server" Width="184px"></asp:textbox></td>
							</tr>
							<tr vAlign="top">
								<td class="logon" width="249" height="21"><asp:label id="Label25" runat="server">Gross Income</asp:label></td>
								<td class="data" width="60%" height="21"><asp:textbox id="txtGin" runat="server" Width="184px"></asp:textbox></td>
							</tr>
							<tr vAlign="top">
