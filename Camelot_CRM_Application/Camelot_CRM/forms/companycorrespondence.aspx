<%@ Page language="c#" Codebehind="companycorrespondence.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.companycorrespondence" %>
	...
	<body>
		...
		<form id="Form1" runat="server">
			...
			<table width="96%" align="center">
				<tr>
					<td class="logon"><asp:label id="Label1" runat="server" Font-Size="20pt">Company Correspondence</asp:label></td>
				</tr>
			</table>
			<hr width="96%">
