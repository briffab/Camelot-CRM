<%@ Page language="c#" Codebehind="applications_UK.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.applications_UK" %>
...
<HTML>
	...
	<body>
		...
		<form id="Form1" runat="server">
			...
			<table width="96%" align="center">
				<tr>
					<td vAlign="right" align="right" width="80%"><input class="button" id="btnDelete" type="button" value="Delete" runat="server"></td>
					<td vAlign="right" align="right" width="10%"><input class="button" id="btnHeld" type="button" value="Hold" runat="server"></td>
					<td vAlign="right" align="right" width="10%"><input class="button" id="btnEmail" type="button" value="Email" runat="server"></td>
				</tr>
			</table>
			<table width="96%" align="center">
				<tr>
