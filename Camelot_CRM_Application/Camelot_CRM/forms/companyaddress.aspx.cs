...
namespace Camelot.forms
{
	...
	/// </summary>
	public class companyaddress : System.Web.UI.Page
	{
		...
		cc.cCompany lcomp = new Camelot.classes.cCompany();
		...
		private void popaddr()
		{
			...
			cmd.CommandText = "get_visit_address";

			cmd.Parameters.Add(
				new SqlParameter("@comp", lcomp.Company_ID));
		...
		private void saveaddress()
		{
			...
			cmd.Connection = conn;
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "save_visit_address";
