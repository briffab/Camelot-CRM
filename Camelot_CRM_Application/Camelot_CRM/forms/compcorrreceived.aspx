<%@ Page language="c#" Codebehind="compcorrreceived.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.compcorrreceived" %>
	...
	<BODY onunload="parent.location.reload(true);">
		<form id="Form1" method="post" runat="server">
			<table width="96%" align="center">
				<tr>
					<td class="logon" width="100%" height="14"><asp:label id="Label20" runat="server" Font-Size="20pt">Recieved Company Correspondence</asp:label></td>
				</tr>
			</table>
			<hr width="96%">
			<table width="96%" align="center">
