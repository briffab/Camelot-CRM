...
namespace Camelot
{
	...
	/// </summary>
	public class propertyguardianspending : System.Web.UI.Page
	{
		...
		private void getGuardians(int propid)
		{
			...
			cmd.CommandText = "get_pending_property_residents";
		...
		private void Button1_ServerClick(object sender, System.EventArgs e)
		{
			...
			Response.Write("<script>self.document.location.href = 'propertyguardianspending.aspx';</script>");
		}
	}
}
