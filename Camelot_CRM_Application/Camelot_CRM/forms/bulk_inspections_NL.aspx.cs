...
namespace Camelot.forms
{
	...
	/// </summary>
	public class bulk_inspections_NL : System.Web.UI.Page
	{
		...
		public void ShowReport(Object sender, DataGridCommandEventArgs e) 
		{
			...
			Response.Write("<script>window.showModalDialog('insp_brep_NL.aspx?insp=" + t + "&action=view','note','dialogHeight: 485px; dialogWidth: 800px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
