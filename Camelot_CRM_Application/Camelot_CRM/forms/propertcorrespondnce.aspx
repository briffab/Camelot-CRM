<%@ Page language="c#" Codebehind="propertcorrespondnce.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.propertcorrespondnce" %>
	...
	<body>
		...
		<form id="Form1" runat="server">
			...
			<table width="96%" align="center">
				<tr>
					<td class="logon"><asp:label id="Label1" runat="server" Font-Size="20pt">Property Correspondence</asp:label></td>
				</tr>
			</table>
			<hr width="96%">
			<table id="tblDetails" width="96%" align="center" border="0">
				<tr>
					<td class="logon" vAlign="top" width="25%" height="21"><asp:label id="lblTarget" runat="server" CssClass="logon">Target</asp:label></td>
					<td><asp:dropdownlist id="cmbTarget" runat="server" CssClass="logon" AutoPostBack="True" Width="100%"></asp:dropdownlist></td>
				</tr>
			</table>
			<hr width="96%">
				...
				<tr>
					<td vAlign="top" width="100%" colSpan="2">
						<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 300px"><asp:datagrid id="dgRecipients" runat="server" Font-Size="8" Width="100%" AutoGenerateColumns="False"
							...
							</asp:datagrid><asp:datagrid id="dgGuardians" runat="server" Font-Size="8" Width="100%" AutoGenerateColumns="False"
								GridLines="None" CellPadding="5" Font-Name="arial" ForeColor="#56a80f" Font-Bold="false" HorizontalAlign="Center">
								<HeaderStyle BackColor="#56a80f" ForeColor="#dae7ca" Font-Bold="True" HorizontalAlign="Left" />
								<Columns>
