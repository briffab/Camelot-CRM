<%@ Page language="c#" Codebehind="All_incidents.aspx.cs" AutoEventWireup="false" Inherits="Camelot.All_incidents" %>
	...
	<body onkeydown="keystroke()">
		...
		<form ID="Form1" name="Form1" runat="server">
			<table width="96%" align="center">
				<tr>
					<td class="logon">
						<asp:Label id="LblProp" runat="server" Font-Size="20pt">All Unresolved Incidents</asp:Label>
					</td>
				</tr>
				<tr>
					<td class="logon">
						<asp:Label id="lblCnt" runat="server" Font-Size="10pt"></asp:Label>
					</td>
				</tr>
			</table>
			<table width="96%" align="center">
				<tr>
					<td valign="top">
						<div style=" OVERFLOW:auto; WIDTH:100%; HEIGHT:500px">
							<asp:datagrid id="dgIncs" name="dgIncs" AllowSorting="true" OnSortCommand="SortIncs" runat="server"
								Width="100%" AutoGenerateColumns="False" GridLines="None" CellPadding="5" Font-Name="arial"
								Font-Size="8" ForeColor="#56a80f" Font-Bold="false" HorizontalAlign="Center" DataKeyField="inc"
								OnItemDataBound="dgIncs_ItemDataBound">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="act_date" HeaderText="Date of Action" DataFormatString="{0:dd MMMM yyyy HH:mm}"
										SortExpression="act_date">
										<ItemStyle Width="15%" VerticalAlign="top"></ItemStyle>
									</asp:BoundColumn>
									...
									<asp:BoundColumn DataField="resolution_date" HeaderText="Resolution Date" SortExpression="res_date"
										...
										<ItemStyle Width="17%" VerticalAlign="top"></ItemStyle>
									</asp:BoundColumn>
								</Columns>
							</asp:datagrid>
						</div>
