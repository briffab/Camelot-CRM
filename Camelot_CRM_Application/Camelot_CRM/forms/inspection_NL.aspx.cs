...
namespace Camelot.forms
{
	...
	/// </summary>
	public class inspection_NL : System.Web.UI.Page
	{
		...
		private void btnOwner_Click(object sender, System.EventArgs e)
		{
			...
			else if(email == "1")
			{
				...
				Response.Write("<script>window.showModalDialog('insp_rep_NL.aspx?action=send','note','dialogHeight: 485px; dialogWidth: 800px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
			}
			else
			{
				Response.Write("<script>window.showModalDialog('emailinsp_NL.aspx?=" + linsp.Inspection_ID + "','note','dialogHeight: 700px; dialogWidth: 800px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
			}
		}

		private void btnView_Click(object sender, System.EventArgs e)
		{
			Response.Write("<script>window.showModalDialog('insp_rep_NL.aspx?action=view','note','dialogHeight:600px; dialogWidth: 800px; dialogTop: 100px; dialogLeft:100px; edge: Raised; center: No; help: No; resizable: No; status: No;');</script>");
		}
