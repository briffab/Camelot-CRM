...
namespace Camelot 
{
	...
	public class Global : System.Web.HttpApplication
	{
		...
		protected void Session_Start(Object sender, EventArgs e)
		{
			...
			//Session["server"] = "FUJI";
			//Session["pwd"] = "fvzappa3";
			Session["server"]= "192.168.75.1";
			Session["pwd"] = "sa";
			string con = "server=" + Session["server"].ToString() + ";integrated security=false;uid=sa;pwd=" + Session["pwd"].ToString() + ";database=camelot_login;";
			//string con = "server=FUJI;integrated security=false;uid=sa;pwd=fvzappa3;database=camelot_login;";
