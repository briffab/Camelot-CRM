...
namespace Camelot.Reports {
    ...
    public class insp_rep_NL : ReportClass {
    ...
    public class Cachedinsp_rep_NL : Component, ICachedReport {
        
        public Cachedinsp_rep_NL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            insp_rep_NL rpt = new insp_rep_NL();
            rpt.Site = this.Site;
            return rpt;
        }
