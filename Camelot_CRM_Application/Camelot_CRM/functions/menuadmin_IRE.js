...
// AddSubItem(idParent, text, hint, location, linktarget);
	...
	menu.addSubItem("applications", "Guardian Applications", "Guardian Applications",  "applications_IRE.aspx", "");
	menu.addSubItem("applications", "Held Applications", "Held Applications",  "applicants_held_IRE.aspx", "");
	menu.addSubItem("applications", "Placed Guardian Applications", "Placed Guardian Applications",  "placed_applicants_IRE.aspx", "");
