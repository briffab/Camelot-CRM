...
// AddSubItem(idParent, text, hint, location, linktarget);
	...
	menu.addSubItem("properties", "Inspections", "Inspections",  "inspections_nl.aspx", "");
	
	menu.addSubItem("Inspections", "Bulk Inspections", "Inspections",  "bulk_inspections_NL.aspx", "");
	...
	menu.addSubItem("applications", "Guardian Applications", "Guardian Applications",  "applications_NL.aspx", "");
	menu.addSubItem("applications", "Held Applications", "Held Applications",  "applicants_held_NL.aspx", "");
	menu.addSubItem("applications", "Placed Applications", "Placed Guardian Applications",  "placed_applicants_NL.aspx", "");
	...
	menu.addSubItem("administration", "Import Pictures", "Import Pictures", "import_pictures.aspx", "")
