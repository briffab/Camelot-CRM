<%@ Page language="c#" Codebehind="database.aspx.cs" AutoEventWireup="false" Inherits="Camelot.forms.database" %>
...
method=post runat="server">
			...
			<table height="20%" width="100%" border="0">
				...
				<tr height="100%" width="100%">
					<td class="Logon" vAlign="bottom" align="right" width="45%">Database</td>
					<td vAlign="bottom" align="left" width="55%"><asp:dropdownlist id="cmbDatabase" runat="server" CssClass="logon" Width="184"></asp:dropdownlist></td>
					</TD></tr>
				<tr height="100%" width="100%">
					<td class="Logon" vAlign="top" align="right" width="45%">&nbsp;</td>
					<td vAlign="top" align="left" width="55%"><asp:button id="btnLogon" class="button" runat="server" Text="Open"></asp:button></td>
				</tr>
			</table>
